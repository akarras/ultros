...
fn main() {
    ...
    scope.raw("#[allow(unused_imports)] use std::collections::HashMap;");
    scope.raw("#[allow(unused_imports)] use crate::subrow_key::SubrowKey;");
    scope.raw("#[allow(unused_imports)] use derive_more::FromStr;");
    scope.raw("#[allow(unused_imports)] use dumb_csv::DumbCsvDeserialize;");
