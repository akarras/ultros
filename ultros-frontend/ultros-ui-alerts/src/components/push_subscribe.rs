...
pub type SubscribeResult = Result<Endpoint, String>;

#[cfg(all(feature = "hydrate", target_arch = "wasm32"))]
pub async fn enable_browser_notifications() -> SubscribeResult {
...
#[cfg(all(feature = "hydrate", target_arch = "wasm32"))]
pub async fn disable_browser_notifications(endpoint_url: &str) -> Result<bool, String> {
...
#[cfg(not(all(feature = "hydrate", target_arch = "wasm32")))]
pub async fn disable_browser_notifications(_endpoint_url: &str) -> Result<bool, String> {
    Err("Web Push is only available in the browser".into())
}
