...
pub const LISTING_PREVIEW_ROWS: usize = 10;

/// How many rows to render for a given expansion state.
pub fn visible_listing_count(total: usize, show_more: bool) -> usize {
    if show_more {
        total
    } else {
...
pub fn has_more_listings(total: usize, show_more: bool) -> bool {
