...
pub fn rows_for_viewport(viewport: f64, avg_row_height: f64, overscan: u32) -> u32 {
...
pub fn rendered_range(first: usize, shown: usize, len: usize) -> (usize, usize) {
    if len == 0 {
        return (0, 0);
    }
