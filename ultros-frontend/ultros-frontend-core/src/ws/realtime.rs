...
mod client {
    ...
    impl RealtimeClient {
        ...
        pub fn send_list_doc_update(&self, list_id: i32, update: Vec<u8>) -> bool {
...
mod client {
    ...
    impl RealtimeClient {
        ...
        pub fn send_list_doc_update(&self, _list_id: i32, _update: Vec<u8>) -> bool {
            false
        }
    }
}

pub use client::{RealtimeClient, RealtimeSubscription};
...
pub fn provide_realtime_context() {
    provide_context(RealtimeClient::new());
}

pub fn use_realtime() -> Option<RealtimeClient> {
