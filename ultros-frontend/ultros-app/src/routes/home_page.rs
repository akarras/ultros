            ...
            <div class="container flex flex-col gap-6 lg:flex-row-reverse mx-auto items-start max-w-7xl">
                ...
                <div class="flex flex-col grow gap-8">
                    <div class="text-2xl font-light bg-gradient-to-r from-violet-200 to-amber-200
                        ...
                        "Ultros is a modern market board tool for Final Fantasy 14." <br/>
                        "Get started by reading the "
                        <b><a href="https://book.ultros.app" class="text-amber-300 hover:text-amber-200 transition-colors">"book"</a></b>
                        " and inviting the "
                        <a rel="external" href="/invitebot" class="text-amber-300 hover:text-amber-200 transition-colors">
