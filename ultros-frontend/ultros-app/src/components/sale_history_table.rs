...
#[component]
pub fn SaleHistoryTable(#[prop(into)] sales: Signal<Vec<Arc<SaleHistory>>>) -> impl IntoView {
...
#[component]
pub fn SalesInsights(#[prop(into)] sales: Signal<Vec<Arc<SaleHistory>>>) -> impl IntoView {
