...
pub fn AddRecipeToList(recipe: &'static Recipe) -> impl IntoView {
    ...
    let result_item = items.get(&ItemId(recipe.item_result as i32));
    view! {
...
fn AddRecipeToListModal(
    ...
    let result_item = move || items.get(&ItemId(recipe.item_result as i32));
        ...
        <Modal set_visible>
            <div class="panel p-6 rounded-xl space-y-4">
                <div class="flex items-start gap-3">
                    <div class="shrink-0">
                        <ItemIcon item_id={recipe.item_result as i32} icon_size=IconSize::Medium />
                    </div>
