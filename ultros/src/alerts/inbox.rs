...
pub(crate) fn alert_event_to_api(m: alert_event::Model) -> AlertEvent {
    AlertEvent {
        id: m.id,
        alert_id: m.alert_id,
...
pub(crate) struct AlertFire<'a> {
    pub(crate) alert_id: i32,
    pub(crate) owner: i64,
    pub(crate) item_id: i32,
    pub(crate) matched_listing_id: Option<i64>,
    pub(crate) matched_price: Option<i32>,
    pub(crate) title: &'a str,
    pub(crate) body: &'a str,
    pub(crate) click_url: &'a str,
