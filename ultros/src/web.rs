...
use self::handlers::misc::{
    detect_region, fallback_item_icon, favicon, get_bincode, get_item_icon, robots, search,
    static_path, world_data,
};
...
use self::handlers::user::{current_user, delete_user, invite};
use self::oauth::{begin_login, logout};
...
use crate::web::{alerts_websocket::connect_websocket, item_card::item_card};
