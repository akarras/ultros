...
pub(crate) const ENV: &str = "ULTROS_TEST_MARKET_ISOLATION";
pub(crate) const BLOCKED: &str = "Upstream writes blocked by test-auth market fixture isolation";
...
fn from_value(raw: Option<&str>) -> bool {
    crate::env_flag_enabled(ENV, raw)
}
