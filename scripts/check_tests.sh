...
# the first version of the patch broke (#1511).
cargo test --locked --manifest-path vendor/reactive_graph/Cargo.toml --lib --test memo_concurrent --test async_source_walk
