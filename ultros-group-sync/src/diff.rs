...
pub const REMOVAL_BREAKER_MIN_MEMBERS: usize = 10;
...
pub const REMOVAL_BREAKER_PERCENT: usize = 50;
...
pub fn check_member_list(members: &[GuildMember]) -> Result<(), UnsafePlan> {
    if members.is_empty() {
...
pub fn check_removals(role_id: i32, removes: usize, current: usize) -> Result<(), UnsafePlan> {
...
pub fn is_everyone_role(guild_id: i64, discord_role_id: i64) -> bool {
...
pub fn plan(role_id: i32, desired: &BTreeMap<i64, String>, current: &HashSet<i64>) -> RoleSyncPlan {
    let adds = desired
        .iter()
