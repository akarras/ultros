...
pub const VENDOR_ANCHOR_MULTIPLE: i64 = 100;
...
pub fn conservative_median(prices: &mut [i32]) -> i32 {
...
pub fn velocity_per_day(count: usize, span_days: f32) -> Option<f32> {
    if count == 0 {
        return None;
    }
...
impl EligibilityPolicy {
    pub fn accepts(&self, row: &Candidate) -> bool {
